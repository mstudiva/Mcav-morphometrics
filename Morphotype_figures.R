...
ggsave("morphotype_meansfig_box.tiff", plot= plot1, width=6, height=6, units="in", dpi=300)
...
#saves plot as TIFF and EPS
ggsave("morphotype_supp_box.tiff", plot= plot2, width=6, height=6, units="in", dpi=300)
...
#saves plot as TIFF and EPS
ggsave("morphotype_zoox_box.tiff", plot= plot3, width=6, height=8, units="in", dpi=300)
